...
const uint8 I2CReadUUID[2] = {0x0Fu, 0x18u};
const uint8 I2CReadDataUUID[2]= {0x19u, 0x2Au};
const uint8 I2CWriteUUID[2] = {0xA6u, 0xFEu};
const uint8 I2CWriteDataUUID[16] = {0x1bu, 0xc5u, 0xd5u, 0xa5u, 0x02u, 0x00u, 0x46u, 0x90u, 0xe3u, 0x11u, 0x8du, 0xaau, 0x72u, 0x00u, 0xf9u, 0xb5u};
const CYBLE_GATT_VALUE_T I2CReadServiceUuidInfo = {(uint8 *) I2CReadUUID, CYBLE_GATT_16_BIT_UUID_SIZE, CYBLE_GATT_16_BIT_UUID_SIZE };
const CYBLE_GATT_VALUE_T I2CWriteServiceUuidInfo = {(uint8 *) I2CWriteUUID, CYBLE_GATT_16_BIT_UUID_SIZE, CYBLE_GATT_16_BIT_UUID_SIZE };
...
//					&& (advReport->data[6] == 'C') )
        ...
        case CYBLE_EVT_GATTC_READ_BY_TYPE_RSP:
            ...
            if(0 == memcmp((uint8 *)&(readResponse->attrData.attrValue[5]), (uint8 *)I2CReadDataUUID, 1))
            {
